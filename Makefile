...
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=0 USE_UPNP=- -o Makefile xgamecoin-qt.pro
#############################################################################
...
Makefile: xgamecoin-qt.pro ../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=0 USE_UPNP=- -o Makefile xgamecoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:\xgamecoin-modified\src\leveldb\libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:\xgamecoin-modified\src\leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\xgamecoin-modified\xgamecoin-qt_plugin_import.cpp

C:/xgamecoin-modified/src/leveldb/libleveldb.a: FORCE
