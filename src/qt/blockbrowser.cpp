...
{
    if(Height > pindexBest->nHeight) { return "00000f759ad7a4af3b825706a2c2f6d09db07b3760e3587a66e19eff22f24120"; }
    if(Height < 0) { return "00000f759ad7a4af3b825706a2c2f6d09db07b3760e3587a66e19eff22f24120"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->txID->setText(QID);
        ui->valueBox->setText(QValue + " POS");
        ui->feesBox->setText(QFees + " POS");
